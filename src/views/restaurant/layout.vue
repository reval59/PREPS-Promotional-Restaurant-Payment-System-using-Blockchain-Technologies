        ...
        >
            <v-list>
                ...
                >
                    ...
                    <v-list-tile @click="go('/restaurant/form-partnership')">
                        <v-list-tile-content>
                            <v-list-tile-title>Form Partnership</v-list-tile-title>
                        </v-list-tile-content>
                    </v-list-tile>

                    <v-list-tile @click="go('/restaurant/partnership-management')">
                        <v-list-tile-content>
    ...
    export default {
        ...
        watch: {
            ...
            '$route':function (val, oldval) {
                if(this.$store.state.user.myRestaurant==null && val.path.startsWith('/restaurant')){
